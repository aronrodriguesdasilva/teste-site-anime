    ...
    <div className="w-full flex flex-col items-center">
      ...
      <section className="w-full max-w-4xl px-4">
        <div className="flex items-center justify-end gap-3 mb-8">
          <h2 className="text-ink dark:text-white tracking-tighter text-3xl font-black uppercase text-right">Visão Editorial</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="group relative p-6 bg-paper dark:bg-gray-manga-dark border-2 border-ink dark:border-white hover:shadow-manga dark:hover:shadow-manga-dark transition-all duration-300">
            ...
            <h3 className="text-ink dark:text-white font-black uppercase text-lg mb-3 mt-2 border-b-2 border-gray-100 dark:border-gray-800 pb-2">Foco Estético</h3>
          ...
          <div className="group relative p-6 bg-paper dark:bg-gray-manga-dark border-2 border-ink dark:border-white hover:shadow-manga dark:hover:shadow-manga-dark transition-all duration-300">
            ...
            <h3 className="text-ink dark:text-white font-black uppercase text-lg mb-3 mt-2 border-b-2 border-gray-100 dark:border-gray-800 pb-2">Profundidade Crítica</h3>
        ...
        <div className="bg-paper dark:bg-gray-manga-dark border-2 border-ink dark:border-white p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-8 shadow-manga dark:shadow-manga-dark">
          ...
          <div className="flex flex-col text-center md:text-left w-full">
            <div className="mb-1 flex flex-col md:flex-row md:items-baseline gap-2">
              ...
              <span className="text-xs font-bold bg-ink text-white dark:bg-white dark:text-ink px-2 py-0.5 uppercase tracking-wider">Editor Chefe</span>
            </div>
